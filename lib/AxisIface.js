...
export const xAxisIface = {
  ...
  labelRotationAngle: PropTypes.number,  // sets the angle for drawing the X axis labels (in degrees)
  avoidFirstLastClipping: PropTypes.bool,  // if set to true, the chart will avoid that the first and last label entry
